...
class WeblinkController extends Controller {
    ...
    public function actionIndex($id) {
        ...
        $criteria->select = '*';
        $criteria->addCondition('published=1 AND category_id=' . $id . ' OR category_id IN(SELECT c.id FROM {{weblink_category}} c WHERE c.parent_id=' . $id . ')');
        $criteria->order = 'title ASC';

        $dataProvider = new CActiveDataProvider('Weblink', array(
            'criteria' => $criteria,
            'pagination' => array(
