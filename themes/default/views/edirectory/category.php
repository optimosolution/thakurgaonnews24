...
$this->breadcrumbs = array(
    ...
    DirectoryCategory::getDirectoryCategory($_REQUEST['id']),
);
?>

<h1><?php echo DirectoryCategory::getDirectoryCategory($_REQUEST['id']); ?></h1>
<div class="row">
            ...
            <div class="block">
                ...
                <div class="tab-content">
                    <div id="fav" class="tab-pane active">
                        <h3 class="post-title">Sub Categories</h3>
                        <?php $this->get_directory_subcategory_list($_REQUEST['id']); ?>
                    </div>
                </div> <!-- tab-content -->
            </div>           
        </aside> <!-- Sidebar -->
